...
This is largely based upon github:LegitMagic/nix-config
...
- Install with `sudo nixos-install --no-root-passwd --no-channel-copy --flake github:speedacm/lab-config#{hostname}`[^2]
